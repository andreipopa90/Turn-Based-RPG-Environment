...
exports.Conditions = {
    ...
    confusion: {
        ...
        onBeforeMove: function (pokemon) {
            ...
            var damage = this.actions.getConfusionDamage(pokemon, 40);
            if (typeof damage !== 'number')
                throw new Error("Confusion damage not dealt");
            var activeMove = { id: this.toID('confused'), effectType: 'Move', type: '???' };
    ...
    partiallytrapped: {
        ...
        durationCallback: function (target, source) {
            if (source === null || source === void 0 ? void 0 : source.hasItem('gripclaw'))
                return 8;
        ...
        onResidual: function (pokemon) {
            ...
            var gmaxEffect = ['gmaxcentiferno', 'gmaxsandblast'].includes(this.effectState.sourceEffect.id);
        ...
        onTrapPokemon: function (pokemon) {
            var _a;
            var gmaxEffect = ['gmaxcentiferno', 'gmaxsandblast'].includes(this.effectState.sourceEffect.id);
            if (((_a = this.effectState.source) === null || _a === void 0 ? void 0 : _a.isActive) || gmaxEffect)
                pokemon.tryTrap();
        }
    },
    lockedmove: {
    ...
    twoturnmove: {
        ...
        name: 'twoturnmove',
        duration: 2,
        onStart: function (attacker, defender, effect) {
    ...
    futuremove: {
        ...
        onResidualOrder: 3,
        onEnd: function (target) {
            var data = this.effectState;
            // time's up; time to hit! :D
            var move = this.dex.moves.get(data.move);
            if (target.fainted || target === data.source) {
                this.hint("".concat(move.name, " did not hit because the target is ").concat((target.fainted ? 'fainted' : 'the user'), "."));
                return;
            }
            ...
            var hitMove = new this.dex.Move(data.moveData);
    ...
    stall: {
        ...
        onStallMove: function (pokemon) {
            ...
            var counter = this.effectState.counter || 1;
            this.debug("Success chance: " + Math.round(100 / counter) + "%");
            var success = this.randomChance(1, counter);
            if (!success)
    ...
    raindance: {
        ...
        durationCallback: function (source, effect) {
            if (source === null || source === void 0 ? void 0 : source.hasItem('damprock')) {
                return 8;
            }
            return 5;
        },
    ...
    sunnyday: {
        ...
        duration: 5,
        durationCallback: function (source, effect) {
            if (source === null || source === void 0 ? void 0 : source.hasItem('heatrock')) {
                return 8;
            }
            return 5;
        },
        ...
        onFieldStart: function (battle, source, effect) {
            if ((effect === null || effect === void 0 ? void 0 : effect.effectType) === 'Ability') {
                if (this.gen <= 5)
                    this.effectState.duration = 0;
    ...
    sandstorm: {
        ...
        duration: 5,
        durationCallback: function (source, effect) {
            if (source === null || source === void 0 ? void 0 : source.hasItem('smoothrock')) {
                return 8;
            }
            return 5;
        },
    ...
    hail: {
        ...
        duration: 5,
        durationCallback: function (source, effect) {
            if (source === null || source === void 0 ? void 0 : source.hasItem('icyrock')) {
                return 8;
            }
            return 5;
        },
    ...
    dynamax: {
        ...
        onStart: function (pokemon) {
            ...
            var ratio = 2; // TODO: Implement Dynamax levels
